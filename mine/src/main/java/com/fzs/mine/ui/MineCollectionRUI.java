 ...
 * @author
 */
@Route(path = "/mine/MineCollectionRUI")
public class MineCollectionRUI extends AbsRecyclerViewUI<MineCollection> {
    
    @Override
    protected int setLayoutId() {
        return R.layout.mine_collection_list;
    }
    ...
    protected int setItemLayoutId(int viewType) {
        return R.layout.mine_item_rv_collection;
    }
