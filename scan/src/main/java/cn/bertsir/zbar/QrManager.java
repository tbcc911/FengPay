        ...
        PermissionUtils.permission(activity, PermissionConstants.CAMERA,PermissionConstants.STORAGE)
                ...
                .callback(new PermissionUtils.FullCallback() {
                    ...
                    public void onGranted(List<String> permissionsGranted) {
                        Intent intent = new Intent(activity, QRUI.class);
                    ...
                    public void onDenied(List<String> permissionsDeniedForever,
                        ...
                        Toast.makeText(activity, ComnConfig.applicationContext.getString(R.string.scan_text_5),Toast.LENGTH_SHORT).show();
