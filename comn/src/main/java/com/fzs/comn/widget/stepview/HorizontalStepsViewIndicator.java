...
public class HorizontalStepsViewIndicator extends View {
    ...
    private int mUnCompletedLineColor = getResources().getColor(R.color.green);//定义默认未完成线的颜色  definition mUnCompletedLineColor
    ...
    private void init() {
        ...
        mCompleteIcon = getResources().getDrawable(R.mipmap.complted);//已经完成的icon
        mAttentionIcon = getResources().getDrawable(R.mipmap.attention);//正在进行的icon
        mDefaultIcon = getResources().getDrawable(R.mipmap.default_icon);//未完成的icon
    }
