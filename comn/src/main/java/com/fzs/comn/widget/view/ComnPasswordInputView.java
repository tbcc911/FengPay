...
public class ComnPasswordInputView extends AppCompatEditText {
    ...
    public ComnPasswordInputView(Context context) {
        this(context, null);
    }

    public ComnPasswordInputView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.editTextStyle);
//        this(context, attrs, R.style.PasswordInputViewStyle);
    }

    public ComnPasswordInputView(Context context, AttributeSet attrs, int defStyleAttr) {
