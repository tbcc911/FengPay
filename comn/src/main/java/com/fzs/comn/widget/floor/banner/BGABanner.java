package com.fzs.comn.widget.floor.banner;
...
import com.fzs.comn.widget.transformer.BGAPageTransformer;
import com.fzs.comn.widget.transformer.TransitionEffect;
...
public class BGABanner extends RelativeLayout implements BGAViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private int mPointDrawableResId = R.drawable.comn_banner_selector_point_solid;
    ...
    private void initCustomAttr(int attr, TypedArray typedArray) {
        if (attr == R.styleable.BGABanner_banner_pointDrawable) {
            mPointDrawableResId = typedArray.getResourceId(attr, R.drawable.comn_banner_selector_point_solid);
    ...
    public void setData(List<? extends Object> models, List<String> tips) {
        setData(R.layout.comn_floor_item_banner, models, tips);
    }
