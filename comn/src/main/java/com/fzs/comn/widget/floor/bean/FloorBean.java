package com.fzs.comn.widget.floor.bean;
...
public class FloorBean {
    ...
    public static class ItemInfoListBean{
        ...
        public static class ItemContentListBean {
            ...
            public String oldPrice;//原价
            public String subPrice;

            public String number;//数量
            public String buyNumber;//购买量
            public String browseNumber;//浏览量
            public String stockNumber;//库存量
